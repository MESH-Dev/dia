...
<main id="main" class="site-main" role="main">
   <div class="hero">
      ...
      <h3>The Defense Industry Alliance is watching West Virginia's back.</h3>
   ...
   <div class="text-panel white">
      <div class="container">
         <div class="row">
            <div class="columns-6">
               <h2>Revolutionizing the Defense Industry in West Virginia.</h2>
            </div>
            <div class="columns-6">
               <p>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Etiam porta sem malesuada magna mollis euismod.

Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere consectetur est at lobortis. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Vestibulum id ligula porta felis euismod semper. Donec id elit non mi porta gravida at eget metus.</p>
            </div>
         </div>
      </div>
   </div>
   <div class="text-panel blue">
      <div class="container">
         <div class="row">
            <h2 class="centered-heading">Title about the Industry here</h2>
            <div class="columns-6">
...
Sed posuere consectetur est at lobortis. Maecenas sed diam eget risus varius blandit sit amet non magna. Donec id elit non mi porta gravida at eget metus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
            </div>
            <div class="columns-6">
               <p>Cras mattis consectetur purus sit amet fermentum. Donec id elit non mi porta gravida at eget metus. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Donec sed odio dui. Cras mattis consectetur purus sit amet fermentum.</p>
            </div>
         </div>
      </div>
   </div>
   <div class="text-panel bg-image-blue">
      <div class="container">
         <div class="row">
            ...
            <div class="columns-4">
               <p>Donec id elit non mi porta gravida at eget metus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. <i class="fa fa-angle-double-right" aria-hidden="true"></i></p>
            </div>
            <div class="bg-image"></div>
         </div>
      </div>
